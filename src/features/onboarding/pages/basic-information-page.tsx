...
import { addBasicInformation } from "../api/onboarding.api";
import {
...
const stepOneFields: FieldPath<BasicInformation>[] = [
  "name",
  "sex",
  "weight",
  "height",
...
const BasicInformationPage = () => {
  ...
  const handleFormSubmit: SubmitHandler<BasicInformation> = (data) => {
    mutate(data);
  };
