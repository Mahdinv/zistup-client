...
const PlaygroundFlowHeader = ({
  ...
  return (
    <motion.header
      ...
      className="flex h-28 w-full shrink-0 flex-col items-start justify-center bg-darker-blue-200 compact:px-4 mobile-lg:px-6 pt-8 pb-2"
    >
          ...
          <AnimatePresence mode="wait">
            {onBack && (
              <motion.button
                ...
                className="cursor-pointer text-blue-600 outline-none"
              >
                <PiCaretRight
